    ...
    <h3 className='p-14 text-center text-2xl italic'>"Develop a passion for learning. If you do, you will never cease to grow."</h3>
        <div className='m-4 flex align-middle'>
            ...
            <div className="m-8 p-8 text-justify pt-2">
              ...
              Whether learning technical skills such as programming languages, new software tools, algorithms, or soft skills, not a single day goes without learning.
              Subsequently, I have developed a passion not only for computers but also for learning.
              ...
              <p className='m-auto indent-8 text-3xl leading-normal font-about'>
              Apart from being on my laptop, I am also an avid book reader. 
              I have read tons of books from my childhood.
              </p>
              <p className='m-auto indent-8 text-3xl leading-normal font-about'>
              When I am not in the mood of being a techie or a bookworm, I like to play Table Tennis which helps me to rejuvenate my energy.
              </p>
            </div>
